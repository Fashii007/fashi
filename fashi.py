...
def rehan():
	os.system('clear')
	print(logo)
	print('\n\033[1;31m[1] PAK CLONING')
	print('\n\033[1;32m[2] BD CLONING')
	print('\n\033[1;33m[3] RANDOM PASS CLONING')
	print('\n\033[1;34m[4] CONTACT WITH OWNER')
	print('\n\033[1;35m[0] EXIT')
	lines()
	gh = input('[•] CHOOSE : ')
	if gh =='1':
...
def menu():
	os.system('clear')
	print(logo)
	print('\n\033[1;31m[1] LAST 7 DIGIT')
	print('\n\033[1;32m[2] ALI + KHAN PASS')
	print('\n\033[1;33m[3] MALIK + BALOCH PASS')
	print('\n\033[1;34m[4] BEST FOR PUBG IDS')
	print('\n\033[1;35m[5] BEST FOR FREE FIRE IDS')
	print('\n\033[1;36m[0] EXIT TO MAIN MENU')
	lines()
	opt = input('[•] CHOOSE: ')
	if opt =='1':
		svn_digit()
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('\n\033[1;31m[•] EXAMPLE :92318,92345,92323,92306.ETC')
	lines()
